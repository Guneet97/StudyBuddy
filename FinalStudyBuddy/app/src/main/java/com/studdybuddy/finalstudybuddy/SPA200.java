...
public class SPA200 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StudyDatabase2 = FirebaseDatabase.getInstance().getReference().child("Class2").child(post_key).child("comment");
        ...
        AuthState = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (SBAuth.getCurrentUser() == null) {
                    Intent loginIntent = new Intent(SPA200.this, RegisterActivity.class);
    ...
    protected void onStart() {
            ...
            protected void populateViewHolder(MainActivity.DBViewHolder viewHolder, DiscussionBoard model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent singleActivity = new Intent(SPA200.this, CSPA2.class);
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainintent = new Intent(SPA200.this, MAtwohun.class);
        ...
        cmtBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainintent = new Intent(SPA200.this, PASPA2.class);

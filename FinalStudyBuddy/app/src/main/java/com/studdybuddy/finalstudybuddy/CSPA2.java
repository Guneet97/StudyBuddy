...
public class CSPA2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StudyDatabase2 = FirebaseDatabase.getInstance().getReference().child("Class2").child(post_key2).child("comment");
        ...
        AuthState = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if (SBAuth.getCurrentUser()==null){
                    Intent loginIntent = new Intent(CSPA2.this, RegisterActivity.class);
    ...
    protected void onStart() {
        ...
        cmtBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainintent = new Intent(CSPA2.this, MAtwohun.class);

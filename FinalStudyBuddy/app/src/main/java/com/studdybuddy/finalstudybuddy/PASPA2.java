...
public class PASPA2 extends AppCompatActivity {
    // imports
   ...
   // private static final int GALLERY_REQUEST_CODE = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBRef = database.getInstance().getReference().child("Class2").child(post_key).child("comment");
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(PASPA2.this, "POSTED...", Toast.LENGTH_LONG).show();
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if (task.isSuccessful()){
                                                        Intent intent = new Intent(PASPA2.this, SPA200.class);

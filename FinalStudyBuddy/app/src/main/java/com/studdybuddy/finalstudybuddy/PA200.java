...
public class PA200 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBRef = database.getInstance().getReference().child("Class2");
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(PA200.this, "POSTING...", Toast.LENGTH_LONG).show();
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if (task.isSuccessful()){
                                                        Intent intent = new Intent(PA200.this, MAtwohun.class);

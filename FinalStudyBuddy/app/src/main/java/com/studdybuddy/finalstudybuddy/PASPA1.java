...
public class PASPA1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBRef = database.getInstance().getReference().child("Class1").child(post_key).child("comment");
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(PASPA1.this, "Posted...", Toast.LENGTH_LONG).show();
                                    ...
                                    newPost.child("username").setValue(dataSnapshot.child("name").getValue())
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if (task.isSuccessful()){
                                                Intent intent = new Intent(PASPA1.this, SinglePostActivity.class);

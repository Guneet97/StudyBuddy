...
public class PA240 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBRef = database.getInstance().getReference().child("Class3");
        ...
        postBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(PA240.this, "POSTING...", Toast.LENGTH_LONG).show();
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if (task.isSuccessful()){
                                                        Intent intent = new Intent(PA240.this, MAtwoforty.class);
